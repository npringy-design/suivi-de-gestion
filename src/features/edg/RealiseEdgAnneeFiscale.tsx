              ...
              <thead>
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th colSpan={2} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 700, fontSize: 12, padding: '8px 0', background: '#f1f5f9', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '1px solid #e2e8f0', borderRight: '1px solid #cbd5e1' }}>{m}</th>
                    </React.Fragment>
                  ))}
                  <th colSpan={2} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 800, fontSize: 13, padding: '8px 0', background: '#e2e8f0', color: '#0f172a', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '2px solid #cbd5e1' }}>TOTAL</th>
                </tr>
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}></th>
