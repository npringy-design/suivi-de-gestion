...
export default function BudgetEdgAnnuel({ onBack, hideHeader = false }: BudgetEdgAnnuelProps) {
    ...
    return (
      <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
        ...
        {Array.from({ length: 12 }).map((_, m) => {
          ...
          return (
            <React.Fragment key={m}>
              ...
              <td style={{ width: 60, padding: '8px 4px', textAlign: 'right', background: '#f8fafc', fontSize: 11, color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>
                {formatPercent(ratioB)}
              </td>
              ...
              <td style={{ width: 80, padding: '8px 4px', textAlign: 'right', background: '#fff', fontSize: 12, fontWeight: 600, color: ecartColor(eVal), borderLeft: '1px solid #e2e8f0' }}>
        ...
        <td style={{ width: 90, padding: '8px 4px', textAlign: 'right', background: isBlue ? '#eff6ff' : '#fff', fontSize: 12, fontWeight: 600, color: '#0f172a', borderLeft: '2px solid #cbd5e1' }}>
          {formatEuro(rowData.totalB)}
        </td>
        <td style={{ width: 60, padding: '8px 4px', textAlign: 'right', background: '#f8fafc', fontSize: 11, fontWeight: 600, color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>
          {formatPercent(ratioBTotal)}
        </td>
        ...
        <td style={{ width: 90, padding: '8px 4px', textAlign: 'right', background: '#fff', fontSize: 12, fontWeight: 700, color: ecartColor(eValTotal), borderLeft: '1px solid #e2e8f0' }}>
    ...
    return (
      <tr style={{ borderBottom, borderTop }}>
        ...
        {monthCalcs.map((mCalc, m) => {
          ...
          return (
            <React.Fragment key={m}>
              ...
              <td style={{ width: 60, padding: '10px 4px', textAlign: 'right', background: type === 'header' || type === 'total' ? bg : '#f8fafc', color: type === 'header' || type === 'total' ? color : '#64748b', fontSize: 11, fontWeight: weight, borderLeft: '1px solid #e2e8f0' }}>
                {formatPercent(ratioB)}
              </td>
              <td style={{ width: 80, padding: '10px 4px', textAlign: 'right', background: bg, color: color, fontSize: 12, fontWeight: weight, borderLeft: '1px solid #e2e8f0' }}>
                {formatEuro(rVal)}
              ...
              <td style={{ width: 80, padding: '10px 4px', textAlign: 'right', background: bg, color: ecartColor(eVal), fontSize: 12, fontWeight: weight, borderLeft: '1px solid #e2e8f0' }}>
                {ecartText(eVal, invert)}
              </td>
        ...
        <td style={{ width: 90, padding: '10px 4px', textAlign: 'right', background: bg, color: color, fontSize: 12, fontWeight: 800, borderLeft: '2px solid #cbd5e1' }}>
          {formatEuro(totals.budget)}
        </td>
        <td style={{ width: 60, padding: '10px 4px', textAlign: 'right', background: type === 'header' || type === 'total' ? bg : '#f8fafc', color: type === 'header' || type === 'total' ? color : '#64748b', fontSize: 11, fontWeight: 800, borderLeft: '1px solid #e2e8f0' }}>
          {formatPercent(ratioBTotal)}
        </td>
        ...
        <td style={{ width: 90, padding: '10px 4px', textAlign: 'right', background: bg, color: ecartColor(eValTotal), fontSize: 12, fontWeight: 800, borderLeft: '1px solid #e2e8f0' }}>
          {ecartText(eValTotal, invert)}
        </td>
  ...
  // toutes les colonnes du tableau (12 mois × 3 + total) sans dépendre du nombre exact.
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', fontSize: 13, borderTop: '1px solid #f1f5f9', paddingTop: 5, marginTop: 2 }}>
                        ...
                        <span>
                          ...
                          {ecartRatioText(kpiEcart, totals.budget, k.invert) && (
                            <span style={{ marginLeft: 6, fontSize: 12, fontWeight: 600, color: ecartColor(kpiEcart) }}>({ecartRatioText(kpiEcart, totals.budget, k.invert)})</span>
                          )}
                        </span>
                      </div>
                    </div>
                ...
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th colSpan={6} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 700, fontSize: 12, padding: '8px 0', background: '#f1f5f9', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '1px solid #e2e8f0', borderRight: '1px solid #cbd5e1' }}>{m}</th>
                    </React.Fragment>
                  ))}
                  <th colSpan={6} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 800, fontSize: 13, padding: '8px 0', background: '#e2e8f0', color: '#0f172a', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '2px solid #cbd5e1' }}>À DATE {YEAR}</th>
                </tr>
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>BUDGET</th>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 60, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>Ratio</th>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>RÉALISÉ</th>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 60, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#fef9c3', color: '#854d0e', borderLeft: '1px solid #e2e8f0' }}>Ratio</th>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>ÉCART</th>
                  ...
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 90, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#f1f5f9', color: '#475569', borderLeft: '2px solid #cbd5e1' }}>BUDGET</th>
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 60, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>Ratio</th>
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 90, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#f1f5f9', color: '#475569', borderLeft: '1px solid #e2e8f0' }}>RÉALISÉ</th>
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 60, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#fef9c3', color: '#854d0e', borderLeft: '1px solid #e2e8f0' }}>Ratio</th>
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 90, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#f1f5f9', color: '#475569', borderLeft: '1px solid #e2e8f0' }}>ÉCART</th>
