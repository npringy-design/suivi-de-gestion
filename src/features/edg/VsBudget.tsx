      ...
      {!hideHeader && (
        <header style={{ background: '#1e293b', height: 54, padding: '0 36px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0, boxShadow: '0 1px 0 rgba(255,255,255,.05)' }}>
          ...
          <div style={{ color: '#fff', fontSize: 14, fontWeight: 700, letterSpacing: '.06em', textTransform: 'uppercase' }}>
            VS Budget <span style={{ color: '#64748b', margin: '0 8px' }}>|</span> <span style={{ color: '#10b981' }}>{YEAR}</span>
          </div>
        </header>
      )}
        ...
        <div style={{ background: '#fff', borderRadius: 12, boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -1px rgba(0,0,0,0.03)', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '20px 24px', borderBottom: '1px solid #e2e8f0', background: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
            <div>
              ...
              <div style={{ fontSize: 14, fontWeight: 500, color: '#64748b', marginTop: 4 }}>BURO MONTE - REALISE ET ECART AU BUDGET</div>
            </div>
                ...
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th colSpan={4} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 700, fontSize: 12, padding: '8px 0', background: '#f1f5f9', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '1px solid #e2e8f0', borderRight: '1px solid #cbd5e1' }}>{m}</th>
                    </React.Fragment>
                  ))}
                  <th colSpan={4} style={{ position: 'sticky', transform: 'translateZ(0)', top: 0, zIndex: 40, borderBottom: '1px solid #cbd5e1', textAlign: 'center', fontWeight: 800, fontSize: 13, padding: '8px 0', background: '#e2e8f0', color: '#0f172a', textTransform: 'uppercase', letterSpacing: '0.05em', borderLeft: '2px solid #cbd5e1' }}>À DATE {YEAR}</th>
                </tr>
                <tr style={{ height: 34 }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => (
                    <React.Fragment key={i}>
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#f8fafc', color: '#64748b', borderLeft: '1px solid #e2e8f0' }}>REALISE</th>
                      ...
                      <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 80, textAlign: 'center', fontWeight: 600, fontSize: 11, padding: '8px 0', background: '#fee2e2', color: '#991b1b', borderLeft: '1px solid #e2e8f0' }}>ECART BUDGE</th>
                  ...
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 90, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#f1f5f9', color: '#475569', borderLeft: '2px solid #cbd5e1' }}>REALISE</th>
                  ...
                  <th style={{ position: 'sticky', transform: 'translateZ(0)', top: 34, zIndex: 40, borderBottom: '2px solid #cbd5e1', width: 90, textAlign: 'center', fontWeight: 700, fontSize: 11, padding: '8px 0', background: '#fee2e2', color: '#991b1b', borderLeft: '1px solid #e2e8f0' }}>ECART BUDGE</th>
