...
export function NavGroup({ title, icon: Icon, children }: NavGroupProps) {
  return (
    <div className="mb-5">
      <div className="flex items-center gap-2 px-5 mb-2.5 text-[10px] font-bold tracking-[0.15em] text-slate-400 uppercase">
...
export function NavItem({ label, onClick, active = false }: NavItemProps) {
  return (
    <button
      onClick={onClick}
      className={`
        group relative text-left px-3.5 py-2.5 rounded-xl text-[13px] font-semibold
        ...
        <div className="flex flex-col h-full relative overflow-hidden">
          ...
          <div className="relative p-5 border-b border-slate-700/50">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[10px] text-slate-400 mt-0.5 tracking-wide">Gestion Restaurant</p>
              </div>
              <button
            ...
            <div className="space-y-2">
              <select
                ...
                className="w-full px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
              >
          ...
          <div className="relative p-4 border-t border-slate-700/50">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold shadow-lg text-sm">
                R
              </div>
              <div>
                <div className="text-xs font-bold text-white">Restaurant Pro</div>
                <div className="text-[10px] text-slate-400">Version 2.0</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <section className="animate-slideRight">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">{month} {year}</p>
                </div>
                ...
                <div className="flex gap-3">
                  {weather && (
                    <div className="rounded-xl bg-white border border-slate-200 px-4 py-2.5 text-center shadow-sm">
                      ...
                      <div className="text-[9px] uppercase tracking-wider text-slate-500 font-semibold">Paris</div>
                    </div>
                  )}
                  <div className="rounded-xl bg-white border border-slate-200 px-4 py-2.5 text-center shadow-sm">
                    <div className="flex items-center justify-center gap-2 mb-0.5">
