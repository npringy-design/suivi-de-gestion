              ...
              {forecastDays.length > 0 ? (
                forecastDays.map((day, index) => (
                  ...
                  >
                    ...
                    <div className="mx-auto mt-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/10">
                      {getWeatherIcon(day.code, 'w-8 h-8')}
                    </div>
                    <div className="mt-2 min-h-[28px] text-[11px] font-semibold leading-tight text-cyan-50/80">
