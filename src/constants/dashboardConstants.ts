export const DASHBOARD_COLUMNS = [
  ...
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'CADRE\nCUISINE\n38,54 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'CADRE\nSALLE\n38,54 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'MAITRISE\nCUISINE\n20,85 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'MAITRISE\nSALLE\n20,85 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'NIV I ET II\nCUISINE\n16,04 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'NIV I ET II\nSALLE\n16,04 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'NIV III\nCUISINE\n18,35 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'NIV III\nSALLE\n18,35 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'APPRENT\nI CUISINE\n8,39 €', 'bg-[#fce4d6]'],
  ['FRAIS DE PERSONNEL PROJECTION', 'PROJECTION S/C AVEC PLANIFICATION SKELLO', 'APPRENT\nI SALLE\n8,39 €', 'bg-[#fce4d6]'],
...
export const DASHBOARD_TABS = [
  { id: 'SYNTHESE', label: 'Synthèse Visuelle' },
  { id: 'CA', label: 'CA & Couverts' },
  { id: 'REALISE', label: 'Réalisé' },
  { id: 'EVENEMENTS', label: 'Événements & Démarques' },
