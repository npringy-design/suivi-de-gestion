...
**2b** : Migrer les 7 autres canaux dans cet ordre : Deliveroo → Uber → ClickCollect → AmexAncv → Conecs → CbNepting → Especes. **En cours : `Deliveroo.tsx`, `Uber.tsx`, `ClickCollect.tsx` et `AmexAncv.tsx` migres.**
